    ...
    fun checkEquality(arrayList1: ArrayList<Values>, arrayList2: ArrayList<Values>): Boolean {
        ...
        while (i < arrayList1.size) {
            ...
            while (y < arrayList2.size) {
                if (arrayList1[i].tag.equals(arrayList2[y].tag) && arrayList1[i].hexValue.equals(arrayList2[y].hexValue)) {
                    println(TAG + arrayList1[i].tag + EQUALS + arrayList2[y].tag)
                    println(TAG_MEANING + arrayList1[i].tagMeaning + " = " + arrayList2[y].tagMeaning)
                    println(VALUE + arrayList1[i].value + " = " + arrayList2[y].value)
                    println(HEX_VALUE + arrayList1[i].hexValue + " = " + arrayList2[y].hexValue + "\n")
                    matchCounts++
                    break
                }
                y++
