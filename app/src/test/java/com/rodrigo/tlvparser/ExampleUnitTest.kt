...
class ExampleUnitTest {
    ...
    fun isCorrectTest_1() {
        ...
        val result = UnitTest.checkEquality(arrayList, TLVParser.parseTLV(tlvString))
        val expected = true
    ...
    fun isCorrectTest_2() {
        ...
        arrayList.add(Values("5F28", "Issuer Country Code", "0840", "---"))
        arrayList.add(Values("8A", "Authorisation Response Code", "3030", "00"))
        ...
        arrayList.add(Values("00", "Unknown tag", "---", "---"))
        arrayList.add(Values("00", "Unknown tag", "Did not find last byte of tag 00", "---"))
